 ...
 */
Configure::write('Security.salt', 'nJc1a3kEVX1WAGoNTdonrf8rBv1lBY3cOWIZbfcMUUQ9isI603N5PjuRwt5ggokS');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
Configure::write('Security.cipherSeed', '39970481996265599688948358665062');
